...
int nombre_cases = 1;          // déclaration de la variable contenant le nombre de cases parcourues, vaut 1 car au début le robot est sur une case
int etat_capteur_cc = A2;      // déclaration de la variable contenant l'état du capteur compteur de cases
int new_etat_capteur_cc = A2;  // déclaration de la variable contenant le nouvel état du capteur compteur de cases
int pin_cc = 3;  //déclaration de la pine où est branché le capteur
int c = 0;    //variable contenant la valeur de la variable etat_capteur_cc
int d = 0;  //variable contenant la valeur de la variable new_etat_capteur_cc
